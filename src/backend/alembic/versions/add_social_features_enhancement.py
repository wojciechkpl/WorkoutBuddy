...
def upgrade() -> None:
    ...
    op.add_column('users', sa.Column('account_type', sa.String(20), nullable=False, server_default='public'))
    op.add_column('users', sa.Column('discoverability_level', sa.String(20), nullable=False, server_default='all'))
    op.add_column('users', sa.Column('social_comfort_level', sa.String(20), nullable=True))
    op.add_column('users', sa.Column('preferred_communication_style', sa.String(20), nullable=True))
    op.add_column('users', sa.Column('location_sharing_enabled', sa.Boolean(), nullable=False, server_default='false'))
    ...
    op.add_column('community_groups', sa.Column('category', sa.String(50), nullable=True))
    op.add_column('community_groups', sa.Column('privacy_level', sa.String(20), nullable=False, server_default='public'))
    op.add_column('community_groups', sa.Column('max_members', sa.Integer(), nullable=True))
    op.add_column('community_groups', sa.Column('is_official', sa.Boolean(), nullable=False, server_default='false'))
    op.add_column('community_groups', sa.Column('created_by', sa.Integer(), nullable=True))
    op.add_column('community_groups', sa.Column('activity_level', sa.String(20), nullable=True))
    op.add_column('community_groups', sa.Column('member_count', sa.Integer(), nullable=False, server_default='0'))
    op.add_column('community_groups', sa.Column('challenge_active', sa.Boolean(), nullable=False, server_default='false'))
    ...
    op.create_table('community_roles',
        ...
        sa.ForeignKeyConstraint(['community_id'], ['community_groups.id'], ),
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
        sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_community_roles_id'), 'community_roles', ['id'], unique=False)
    
    # Enhanced challenges table
    op.add_column('challenges', sa.Column('difficulty_level', sa.String(20), nullable=True))
    op.add_column('challenges', sa.Column('success_rate', sa.Numeric(precision=5, scale=2), nullable=True))
    op.add_column('challenges', sa.Column('target_audience', postgresql.JSONB(astext_type=sa.Text()), nullable=True))
    op.add_column('challenges', sa.Column('community_id', sa.Integer(), nullable=True))
    op.add_column('challenges', sa.Column('challenge_type', sa.String(20), nullable=True))
    op.add_column('challenges', sa.Column('participant_limit', sa.Integer(), nullable=True))
    ...
    op.create_table('friend_invitations',
        ...
        sa.Column('invitation_type', sa.String(20), nullable=False),  # email, sms, qr_code, social
        sa.Column('invitation_code', sa.String(100), nullable=False),
        sa.Column('personalized_message', sa.Text(), nullable=True),
        sa.Column('status', sa.String(20), nullable=False, server_default='pending'),  # pending, accepted, expired
    ...
    op.create_index(op.f('ix_friend_invitations_code'), 'friend_invitations', ['invitation_code'], unique=True)
    
    # Privacy controls table
    op.create_table('privacy_controls',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('user_id', sa.Integer(), nullable=False),
        sa.Column('control_type', sa.String(50), nullable=False),  # profile_visibility, workout_sharing, location_sharing
        sa.Column('target_group', sa.String(50), nullable=False),  # friends, community, public, specific_users
        sa.Column('is_enabled', sa.Boolean(), nullable=False, server_default='true'),
        sa.Column('specific_user_ids', postgresql.JSONB(astext_type=sa.Text()), nullable=True),
        sa.Column('created_at', sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
        sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_privacy_controls_id'), 'privacy_controls', ['id'], unique=False)
    
    # Content reports table
    op.create_table('content_reports',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('reporter_id', sa.Integer(), nullable=False),
        sa.Column('reported_content_type', sa.String(20), nullable=False),  # post, message, profile, challenge
    ...
    op.add_column('user_blocks', sa.Column('block_reason', sa.String(100), nullable=True))
    op.add_column('user_blocks', sa.Column('block_type', sa.String(20), nullable=False, server_default='user'))
    ...
    op.create_table('accountability_partnerships',
        ...
        sa.Column('partnership_type', sa.String(20), nullable=False),  # workout_partner, progress_checker, goal_supporter
        sa.Column('status', sa.String(20), nullable=False, server_default='active'),
        sa.Column('goal_compatibility_score', sa.Numeric(precision=3, scale=2), nullable=True),
        sa.Column('schedule_compatibility_score', sa.Numeric(precision=3, scale=2), nullable=True),
        sa.Column('personality_compatibility_score', sa.Numeric(precision=3, scale=2), nullable=True),
        sa.Column('created_at', sa.DateTime(), nullable=True),
        sa.ForeignKeyConstraint(['user_id'], ['users.id'], ),
        sa.ForeignKeyConstraint(['partner_id'], ['users.id'], ),
        sa.PrimaryKeyConstraint('id')
    )
    op.create_index(op.f('ix_accountability_partnerships_id'), 'accountability_partnerships', ['id'], unique=False)
    
    # Enhanced accountability_checkins table
    op.add_column('accountability_checkins', sa.Column('partnership_id', sa.Integer(), nullable=True))
    op.add_column('accountability_checkins', sa.Column('checkin_type', sa.String(20), nullable=True))
    op.add_column('accountability_checkins', sa.Column('shared_with_partner', sa.Boolean(), nullable=False, server_default='true'))
    op.add_column('accountability_checkins', sa.Column('partner_response', sa.Text(), nullable=True))
    op.add_column('accountability_checkins', sa.Column('response_at', sa.DateTime(), nullable=True))
    
    # User subscriptions table for premium features
    op.create_table('user_subscriptions',
        sa.Column('id', sa.Integer(), nullable=False),
        sa.Column('user_id', sa.Integer(), nullable=False),
        sa.Column('subscription_type', sa.String(20), nullable=False),  # basic, premium, premium_safety
        sa.Column('status', sa.String(20), nullable=False, server_default='active'),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_accountability_partnerships_id'), table_name='accountability_partnerships')
