"""recreate_exercises_table

Revision ID: ad0bc1dd4027
Revises: f566f0d38566
Create Date: 2025-06-29 07:32:43.677452
...
revision: str = 'ad0bc1dd4027'
down_revision: Union[str, None] = 'f566f0d38566'
...
def upgrade() -> None:
    ...
    # op.drop_index('idx_exercise_logs_workout_log_id', table_name='exercise_logs')  # Skipped: index does not exist in fresh DB
    # op.drop_table('exercise_logs')  # Skipped: table does not exist in fresh DB
    # op.drop_table('workout_shares')  # Skipped: table does not exist in fresh DB
    # op.drop_index('idx_workout_logs_user_id', table_name='workout_logs')  # Skipped: index does not exist in fresh DB
    # op.drop_table('workout_logs')  # Skipped: table does not exist in fresh DB
    # op.drop_index('idx_user_followers_follower_id', table_name='user_followers')  # Skipped: index does not exist in fresh DB
    # op.drop_index('idx_user_followers_following_id', table_name='user_followers')  # Skipped: index does not exist in fresh DB
    # op.drop_table('user_followers')  # Skipped: table does not exist in fresh DB
    ...
    op.alter_column('user_goals', 'user_id',
               ...
               nullable=False)
    op.alter_column('user_goals', 'target_value',
               existing_type=sa.NUMERIC(precision=10, scale=2),
               type_=sa.Float(),
               nullable=False)
    op.alter_column('user_goals', 'current_value',
               existing_type=sa.NUMERIC(precision=10, scale=2),
               type_=sa.Float(),
    ...
    op.alter_column('users', 'fitness_goal',
               ...
               type_=sa.Enum('WEIGHT_LOSS', 'MUSCLE_GAIN', 'STRENGTH', 'ENDURANCE', 'GENERAL_FITNESS', 'ATHLETIC_PERFORMANCE', name='fitnessgoal'),
               existing_nullable=True)
    op.alter_column('users', 'experience_level',
               existing_type=sa.VARCHAR(length=20),
               type_=sa.Enum('BEGINNER', 'INTERMEDIATE', 'ADVANCED', 'EXPERT', name='experiencelevel'),
               existing_nullable=True)
    ...
    op.add_column('workout_exercises', sa.Column('duration', sa.Integer(), nullable=True))
    ...
    op.add_column('workout_exercises', sa.Column('rest_time', sa.Integer(), nullable=True))
    op.add_column('workout_exercises', sa.Column('actual_reps', sa.String(), nullable=True))
    op.add_column('workout_exercises', sa.Column('actual_weight', sa.String(), nullable=True))
    op.add_column('workout_exercises', sa.Column('notes', sa.Text(), nullable=True))
    op.add_column('workout_exercises', sa.Column('weight_unit', sa.Enum('KG', 'LBS', name='weightunit'), nullable=True))
    op.add_column('workout_exercises', sa.Column('distance_unit', sa.Enum('KM', 'MILES', 'METERS', name='distanceunit'), nullable=True))
    ...
    op.add_column('workouts', sa.Column('scheduled_date', sa.DateTime(), nullable=False))
    ...
    op.add_column('workouts', sa.Column('status', sa.Enum('PLANNED', 'IN_PROGRESS', 'COMPLETED', 'SKIPPED', name='workoutstatus'), nullable=True))
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    op.add_column('workouts', sa.Column('workout_type', sa.VARCHAR(length=50), autoincrement=False, nullable=True))
    op.add_column('workouts', sa.Column('duration_minutes', sa.INTEGER(), autoincrement=False, nullable=True))
    ...
    op.add_column('workout_exercises', sa.Column('order_index', sa.INTEGER(), autoincrement=False, nullable=True))
    op.add_column('workout_exercises', sa.Column('duration_seconds', sa.INTEGER(), autoincrement=False, nullable=True))
    op.add_column('workout_exercises', sa.Column('weight_kg', sa.NUMERIC(precision=5, scale=2), autoincrement=False, nullable=True))
    op.add_column('workout_exercises', sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True))
    op.add_column('workout_exercises', sa.Column('rest_seconds', sa.INTEGER(), autoincrement=False, nullable=True))
    ...
    op.alter_column('users', 'unit_system',
               ...
               existing_server_default=sa.text("'METRIC'::character varying"))
    op.alter_column('users', 'experience_level',
               existing_type=sa.Enum('BEGINNER', 'INTERMEDIATE', 'ADVANCED', 'EXPERT', name='experiencelevel'),
               type_=sa.VARCHAR(length=20),
               existing_nullable=True)
    op.alter_column('users', 'fitness_goal',
               existing_type=sa.Enum('WEIGHT_LOSS', 'MUSCLE_GAIN', 'STRENGTH', 'ENDURANCE', 'GENERAL_FITNESS', 'ATHLETIC_PERFORMANCE', name='fitnessgoal'),
    ...
    op.alter_column('users', 'height',
               ...
               type_=sa.NUMERIC(precision=5, scale=2),
               existing_nullable=True)
    op.add_column('user_goals', sa.Column('status', sa.VARCHAR(length=20), server_default=sa.text("'active'::character varying"), autoincrement=False, nullable=True))
    op.add_column('user_goals', sa.Column('updated_at', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True))
    op.drop_constraint(None, 'user_goals', type_='foreignkey')
    op.create_foreign_key('user_goals_user_id_fkey', 'user_goals', 'users', ['user_id'], ['id'], ondelete='CASCADE')
    ...
    sa.ForeignKeyConstraint(['following_id'], ['users.id'], name='user_followers_following_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='user_followers_pkey'),
    sa.UniqueConstraint('follower_id', 'following_id', name='user_followers_follower_id_following_id_key')
    )
    op.create_index('idx_user_followers_following_id', 'user_followers', ['following_id'], unique=False)
    op.create_index('idx_user_followers_follower_id', 'user_followers', ['follower_id'], unique=False)
    op.create_table('workout_logs',
    sa.Column('id', sa.INTEGER(), server_default=sa.text("nextval('workout_logs_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='workout_logs_user_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['workout_id'], ['workouts.id'], name='workout_logs_workout_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='workout_logs_pkey'),
    postgresql_ignore_search_path=False
    )
    op.create_index('idx_workout_logs_user_id', 'workout_logs', ['user_id'], unique=False)
    ...
    sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.id'], name='workout_shares_user_id_fkey', ondelete='CASCADE'),
    sa.ForeignKeyConstraint(['workout_id'], ['workouts.id'], name='workout_shares_workout_id_fkey', ondelete='CASCADE'),
    ...
    sa.Column('notes', sa.TEXT(), autoincrement=False, nullable=True),
    sa.Column('created_at', postgresql.TIMESTAMP(), server_default=sa.text('CURRENT_TIMESTAMP'), autoincrement=False, nullable=True),
    sa.ForeignKeyConstraint(['workout_log_id'], ['workout_logs.id'], name='exercise_logs_workout_log_id_fkey', ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id', name='exercise_logs_pkey')
    )
    op.create_index('idx_exercise_logs_workout_log_id', 'exercise_logs', ['workout_log_id'], unique=False)
